...
from norman.objects.configs.invocation.output_format import OutputFormat
...
class InvocationConfig(BaseModel):
    ...
    outputs_format: Optional[dict[str, OutputFormat]] = Field(None, description="Mapping of output names to their formats")
